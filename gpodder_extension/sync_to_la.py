...
class gPodderExtension:
    ...
    def on_create_menu(self):
        """
        Called by gPodder to get this extension's contributions
        to the Extras menu
        """
        return [("Sync To LecteurAudio", self.on_sync_to_device_la_activate)]
    ...
    def _init_window(self):
        ...
        self.ui_config.connect_gtk_window(self.window, 'sync_to_la_window', True)
    ...
    def on_sync_to_device_la_activate(self):
